...
\begin{document}
    \onehalfspacing
    \input{src/pagestyle.tex}
    \input{src/titlepage.tex}
    \pagenumbering{Roman}
    \onehalfspacing
    \input{001_Aufgabenstellung.tex}
...
%    \input{010_Räumliche_Beschreibungsformalismen.tex}
    \input{020_Direkte_Kinematik.tex}
    \input{030_Inverse_Kinematik.tex}
    \input{040_Pfadplanung.tex}
    \input{050_Trajektorienplanung.tex}
    \input{190_Fazit.tex}
