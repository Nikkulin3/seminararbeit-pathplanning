...
\begin{document}
    ...
    \pagenumbering{Roman}
    \onehalfspacing
    \input{001_Aufgabenstellung}
    \input{002_Kurzfassung}
    \tableofcontents        % Inhaltsverzeichnis
    \listoffigures        % Abb.verzeichnis
    \listoftables        % Tabellenverzeichnis
    \input{003_Abkuerzungsverzeichnis}
    \cleardoublepage
    \pagenumbering{arabic}
%%%%%%%%%%%%%%     Eigene Kapitel hier einfügen    %%%%%%%%%%%%%%%%%%%%%%
%    \input{010_Räumliche_Beschreibungsformalismen}
    \input{020_Direkte_Kinematik}
    \input{030_Inverse_Kinematik}
    \input{040_Pfadplanung}
%    \input{050_Trajektorienplanung}
    \input{190_Fazit}
%    \input{006_Konzept}
%    \input{007_Umsetzung}
